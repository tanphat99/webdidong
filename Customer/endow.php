...
<div class="container pay">
    <div class="row">
        <h3 class="text-center"><b>ƯU ĐÃI TỪ ĐỐI TÁC</b></h3>
        <img src="../Images/uu_dai_tu_doi_tac.jpg" alt=""> <br> <br>
        <img src="../Images/uu-dai-doi-tac.png" alt=""> <br> <br>
        <img src="../Images/BIDV_2.webp" alt="">
    </div>
</div>
