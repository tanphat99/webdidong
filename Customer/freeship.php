...
<div class="container">
    <div class="row change-delivery">
        <h3 class="text-center"><b>CHÍNH SÁCH VẬN CHUYỂN CỦA LTPSTORE</b></h3>
        <h4><b>1. Đối với đơn hàng nội thành Hà Nội</b></h4>
        <p>LTPSTORE miễn phí giao hàng đối với tất cả các đơn hàng trên TOÀN QUỐC.</p>
        <h4><b>2. Đối với đơn hàng ngoại thành HN và tỉnh lẻ</b></h4>
        <ul>
            <li>LTPSTORE sử dụng dịch vụ chuyển phát trung gian
                (khách hàng sẽ trả chi phí vận chuyển khi nhận hàng)</li>
            <li>Khách hàng sẽ thỏa thuận với nhân viên giao hàng hoặc nhân viên kinh doanh về chi phí vận chuyển</li>
        </ul>
        <h4><b>3. Đối với đơn hàng dự án, doanh nghiệp:</b></h4>
        <p>
            LTPSTORE sử dụng dịch vụ xe của công ty giao hàng tận nơi. Tùy thuộc vào khoảng
            cách và phí vận chuyển sẽ được thỏa thuận trước.
        </p>
    </div>
