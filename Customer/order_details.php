        ...
        <div class="col-md-8">
            <table width="100%" style="background: #fff">
                <tr style="    border-bottom: 3px solid red;">
                    <td><h3>Chi tiết đơn đặt hàng</h3></td>
                ...
                if (mysqli_num_rows($ds_dh) != 0)
                {
                    while ($dh = mysqli_fetch_array($ds_dh))
                    {
                        ...
                        <table class="table" style="background: #fff">
                            ...
                            <?php
                            $tontien = 0;
                            $ct_ddh = view_order_details($idct);
                            ...
                            <tr style="background-color: #fffcf5;">
                                <td colspan="4" style="border: none">
                                    ...
                                    <p style="padding-left: 20px"><b><?php echo $dh['hoten_nn'];?></b></p>
                                    <p style="padding-left: 20px">
                                        <?php echo $dh['sdt_nn'];?> <br>
                                        <?php echo $dh['email_nn'];?> <br>
                                        <?php echo $dh['noi_nhan'];?> <br>
                                        Ghi chú: <?php echo $dh['ghi_chu'];?>
                                    </p>
