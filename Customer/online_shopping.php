...
<div class="container pay">
    <div class="row">
        <h3 class="text-center"><b>HƯỚNG DẪN MUA HÀNG TRỰC TUYẾN</b></h3>
        <div class="container pay-text">
            <h4><b>1. Đặt hàng qua điện thoại</b></h4>
            <p>Quý khách chỉ cần nhấc máy lên và gọi tới tổng đài 1900 6838 hoặc số
                máy 024 7305 6888 máy lẻ 101, 102 để đặt hàng với nhân viên kinh doanh,
                sau đó nhân viên kinh doanh sẽ hướng dẫn Quý khách cách thức thanh toán
                và giao nhận hàng.</p>
            <h4><b>2. Đặt hàng trên Website.</b></h4>
            <p class="text-center">
                <img src="../Images/sup_carrt.PNG" alt="LTPs2">
            </p>
            <p>Quý khách chọn lấy một sản phẩm cần mua sau đó nhấn vào "Mua Ngay"</p>
            <p>
                <img src="../Images/sup_carrt1.PNG" alt="LTPs2">
            </p>
            <p>Quý khách nhập đầy đủ thông tin nhận hàng sau đó nhấn vào "Đặt Hàng"</p>
            <h4><b>Lưu ý</b></h4>
            <ul>
                <li>Để thuận tiện cho việc thực hiện đơn hàng,
                    Quý khách cần ghi đúng đủ thông tin trong mục đăng ký thành viên.</li>
                <li>Mọi đơn hàng thiếu một trong số các thông tin cần thiết
                    (họ tên, địa chỉ, số điện thoại) sẽ bị loại bỏ mà không cần báo trước.</li>
                <li>Những đơn hàng mà LTPStore cho là không hợp lý cũng sẽ bị loại bỏ mà không cần báo trước.</li>
                <li>Những sản phẩm đã hết hàng sẽ được nhân viên kinh doanh gọi điện tư qua sản phẩm tương đương.</li>
            </ul>
        </div>
