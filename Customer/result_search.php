...
<div class="container">
    ...
    <div class="row menu">
        ...
        <div class="col-md-4">
            ...
            <img src="../Images/baner-gif-1%20(3).gif" alt="" class="banner_center">
            <img src="../Images/baner-gif-1%20(4).gif" alt="" class="banner_bottom">
        </div>
    ...
    <?php
        if (isset($_POST['search'])){
            ...
            if (!empty($search)){
                $timkiem = search($search);
        ?>
                <h4><i class="fab fa-sistrix"></i> Từ khóa: ' <b style="color: #d9534f"><?php echo $search; ?></b> '</h4>
        <?php
                if (mysqli_num_rows($timkiem) > 0){
                    while ($num5 = mysqli_fetch_array($timkiem))
                    {
     ?>
                        <div class="products">
                                    ...
                                    <div class="item-description">
                                        ...
                                        <div class="text-content">
                                            ...
                                            <h5>
                                                ...
                                                <small><?php echo number_format($num5['gia_sp'],0,',','.');?>&nbsp;đ</small></h5>
                                        </div>
                                    </div>
                                </a>
                            </div>
     ...
     <?php
                    ...
                    echo "<div class='row text-center' style='padding-bottom: 150px'>".
