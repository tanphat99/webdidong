...
<!--  Body  -->
<div class="container">
    <div class="row change-delivery">
        <h3 class="text-center"><b>CHÍNH SÁCH ĐỔI - TRẢ - HOÀN TIỀN CỦA LTPSTORE</b></h3>
        <h4><b>1. Chính sách trả hàng</b></h4>
        <p>Nhân viên LTPSTORE giao hàng không đúng theo đơn đặt hàng của khách.</p>
        <h4><b>2. Chính sách đổi mới sản phẩm bị lỗi</b></h4>
        <p>Khách hàng vui lòng kiểm tra kĩ hàng hóa trước khi thanh toán hoặc ngay khi nhận hàng,
            LTPSTORE sẽ không chịu trách nhiệm đối với hàng hóa bị lỗi không phải do nhà sản xuất
            gây ra sau khi Khách Hàng đã nhận hàng. </p>
        <p>Trong vòng 7 ngày kể từ lúc mua máy.</p>
        <ul>
            <li>Nếu phát hiện lỗi do phần cứng của nhà sản xuất khách hàng sẽ được đổi sản phẩm mới
                đúng model sản phẩm khách hàng mua trước đó.</li>
            <li>Trường hợp sản phẩm được nhà phân phối thông báo lỗi tất cả model đấy thì khách hàng có thể
                thỏa thuận đổi sang model khác hoặc công ty hoàn tiền lại cho khách hàng.</li>
        </ul>
        <h4><b>3. Trường hợp từ chối đổi mới:</b></h4>
        <ul>
            <li>Sản phẩm không còn mới 100% có dấu hiệu bị tác động từ bên ngoài như sét đánh, môi trường ẩm ướt,
                bụi bậm, côn trùng xâm nhập, sử dụng sai quy cách, tự update Bios, cháy nổ, đổ chất lỏng, rơi rớt,
                va đập, nứt, bể…</li>
            <li>Phần mềm, dữ liệu cài trong máy.</li>
            <li>Các logo của điện thoại, tem của hãng hay của cửa hàng đều phải đảm bảo nguyên vẹn, không bị bung hay
                tháo rời dưới mọi hình thức trong thời gian đổi trả máy.</li>
        </ul>
    </div>
