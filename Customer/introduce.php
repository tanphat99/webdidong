...
<div class="container">
    ...
    <div class="row gioithieu">
        <img src="../Images/banner_ltp.webp" alt="">
        ...
        <h4><a href="Trangchu.php">LTPStore</a> là đối tác trực tiếp của các nhãn hàng và những nhà phân phối uy tín,
        ...
        <h4>
            Vì sao nên chọn LTPStore khi mua hàng cho doanh nghiệp:
        </h4>
        <p>
            <b>LTPStore</b> là <b>đối tác trực tiếp</b> của các nhãn hàng và những nhà phân phối uy tín,
        ...
        <ul>
            ...
            <li>Samsung Việt Nam, Vsmart, Nokia, Oppo, Xiaomi...</li>
            <li>Sony, PGI ( JBL, Harman Kardon ...), DTR ( Energizer, Mophie ... )</li>
            <li>LTPStore cung cấp hàng hoá với đầy đủ hoá đơn cũng như các giấy tờ theo yêu cầu
                của pháp luật Việt Nam.</li>
            <li>Với hơn 10 năm trong lĩnh vực bán lẻ, LTPStore chuyên nghiệp và linh hoạt trong việc
        ...
        <ul>
            <li>Mr.Phát (Hanoi) Mobile (Zalo, Viber, Telegram) : <a href="tel: 096.3785.109" class="text-danger">096.3785.109</a></li>
            <li>Tổng đài tư vấn miễn phí: <a href="tel:0926748870" class="text-danger">0926748870</a> hoặc email: cskh@ltpstore.com.vn.</li>
        </ul>
