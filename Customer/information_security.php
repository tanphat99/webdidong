...
<div class="container pay">
    <div class="row">
        <h3 class="text-center"><b>CHÍNH SÁCH BẢO MẬT</b></h3>
        <hr>
        <p>
            Xin vui lòng đọc chính sách bảo mật một cách cẩn thận để có được một sự hiểu biết rõ ràng
            về cách thức thông tin thông tin cá nhân của bạn được thu thập, sử dụng,
            bảo vệ hoặc xử lý tại <font>LTPStore</font>.
        </p>
        <h4>
            <b>Những thông tin cá nhân nào được thu thập?</b>
        </h4>
        <p>Khi bạn đăng ký nhận bản tin, bạn có thể được yêu cầu cung cấp tên, địa chỉ email hoặc
            các thông tin khác của bạn để giúp LTPStore cải thiện việc cung cấp dịch vụ,
            thông tin khyến mãi.</p>
        <h4><b>Khi nào thông tin được thu thập?</b></h4>
        <p>LTPStore thu thập thông tin khi bạn đăng ký thành viên, hoặc đăng ký nhận bản tin.</p>
        <h4><b>Thông tin được lưu trong bao lâu?</b></h4>
        <p>Thông tin thành viên được lưu trữ từ khi bạn đăng ký hoặc cung cấp các thông
            tin này cho LTPStore qua các tính năng đăng ký. Thông tin thành viên,
            đăng ký sẽ được lưu trữ đến khi người dùng yêu cầu LTPStore hủy các thông tin này.</p>
        <h4><b>Thông tin của bạn được dùng làm gì?</b></h4>
        <p>LTPStore có thể sử dụng các thông tin thu thập từ bạn cho các mục đích sau:</p>
        <ul>
            <li>Nâng cao chất lượng bài viết của Website.</li>
            <li>Để gửi email định kỳ về địa chỉ mail của bạn cho các cập nhật khuyến mại, giảm giá.</li>
        </ul>
        <h4><b>Bảo vệ thông tin khách truy cập</b></h4>
        <p>LTPStore sử dụng chứng chỉ SSL trong kết nối để bảo mật thông tin khách hàng trên website.</p>
        <h4><b>Việc sử dụng ‘cookie’?</b></h4>
        <p>LTPStore không sử dụng các cookie cho các mục đích theo dõi. Bạn có thể
            chọn để máy tính của bạn cảnh báo bạn mỗi khi một cookie được gửi đi, hoặc
            bạn có thể chọn để tắt tất cả các cookie. Nếu bạn tắt cookie tắt, một số tính
            năng sẽ bị vô hiệu hóa và việc duyệt web của bạn sẽ kém hiệu quả hơn do một số
            dịch vụ của của LTPStore có thể sẽ không phát huy hết các tính năng được thiết kế.</p>
        <h4><b>Các bên thứ ba</b></h4>
        <p>LTPStore không bán, trao đổi hoặc chuyển giao các thông tin đăng ký của bạn cho bất kỳ bên thứ ba nào.</p>
