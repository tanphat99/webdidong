        ...
        <div class="col-md-9 right-admin" id="right-admin">
            ...
            <div class="row right-admin-bottom">
                <form class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="bl" placeholder="Bình luận" value="<?php echo $num['ndkh'];?>">
                        </div>
                    </div>
                    <?php
                        $repid = repcmt_id($idrep);
                        $num1 = mysqli_fetch_array($repid);
                    ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="repcmt" id="rep" placeholder="Nội dung phản hồi ....."
                                      class="form-control" cols="30" rows="10"><?php echo $num1['noi_dung'];?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" name="okrep" class="btn btn-danger">Cập nhật phản hồi</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            if (isset($_POST['okrep'])){
                ...
                if (!empty($idkh) && !empty($idbl) && !empty($nd)){
                    $edit_rep = edit_rep($idrep, $idkh, $idbl, $nd);
                    if ($edit_rep){
                        header("location: view_comment.php");
                    }else{
                        echo "<script>alert('Cập nhật phản hồi không thành công !');</script>";
                    }
                }else{
