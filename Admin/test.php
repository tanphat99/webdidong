...
if (isset($_SESSION['account']))
{
    ...
    <div class="row header" style="margin: auto; width: 100%">
        <div class="topnav" id="myTopnav">
            ...
            <a href="order_desc.php">Khách hàng mua nhiều nhất</a>
    ...
    <div class="row body_admin">
        ...
        <div class="col-md-9 right-admin" id="right-admin">
            <div class="row right-admin-top">
                ...
                <span> > </span>
                <a href="order_desc.php">Khách hàng mua hàng nhiều nhất</a>
            </div>
            <div class="row" id="right-admin-bottom">
                <h3>Thống kê khách mua hàng</h3>
                <table class="table table-bordered">
                    ...
                    <?php
                    $tkdh = thongke($idmonth);

                    while ($num = mysqli_fetch_array($tkdh))
                    {
                        ?>
                        <tr>
                            <td><?php echo $num['id_kh'];?></td>
                            <td><?php echo $num['thang'];?></td>
                            <td><?php echo $num['tong'];?></td>
                            <?php
                                $kk = sdh($num['id_kh']);
                                while ($num1 = mysqli_fetch_array($kk))
                                {
                                    ?>
                                    <td><?php echo $num1['sldh'];?></td>
                                    <?php
                                }
                            ?>
                        </tr>
